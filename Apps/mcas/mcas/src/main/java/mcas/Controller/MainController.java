...
public class MainController {
	...
	public static void main(String[] args) throws Exception {
		...
		String[] files = { "Sensors.json", "Locations.json", "Persons.json", "Multimedia.json", "test0.json",
				"test1.json", "test2.json", "test3.json", "test4.json", "test5.json", "test6.json", "test7.json",
				"test8.json", "test9.json", "test10.json", "test11.json", "test12.json" }; // long
		// String[] files = {"Multimedia.json","test0.json", "test1.json", "test2.json",
		// "test3.json", "test4.json", "test5.json", "test6.json","test7.json",
		// "test8.json", "test9.json", "test10.json", "test11.json", "test12.json"}; //
		// long
		// String[] files = { "Sensors.json", "Locations.json", "Persons.json",
		// "Multimedia.json", "test10.json","test11.json"};

		Initializer initializer = new Initializer();
		initializer.setNewDataFiles(files);
		initializer.initialize(false, false, false, graph, TEST_RESOURCES_PATH);

		logg_multiple_insert.info("create multiple 100 times 700 data each");
		Instant start = Instant.now();
		for (int j = 0; j < 1; j++) {
			for (int i = 0; i < 1; i++) {
				initializer.initialize(true, true, false, graph, TEST_RESOURCES_PATH);
			}
		}
